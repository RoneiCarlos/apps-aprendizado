...
public class QuartoBimestreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quarto_bimestre_activity_main);
    ...
    private void salvarSharedPreferences(){
        ...
        mediaEscolar.putString("editMateriaQuartoBimestre", editMateria.getText().toString());
        ...
        mediaEscolar.putString("txtResultadoQuartoBimestre", txtResultado.getText().toString());
        mediaEscolar.putString("txtSituacaoFinalQuartoBimestre", txtSituacaoFinal.getText().toString());
