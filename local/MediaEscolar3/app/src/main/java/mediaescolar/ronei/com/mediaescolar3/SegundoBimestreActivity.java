...
public class SegundoBimestreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.segundo_bimestre_activity_main);
    ...
    private void salvarSharedPreferences(){
        ...
        mediaEscolar.putString("editMateriaSegundoBimestre", editMateria.getText().toString());
        ...
        mediaEscolar.putString("txtResultadoSegundoBimestre", txtResultado.getText().toString());
        mediaEscolar.putString("txtSituacaoFinalSegundoBimestre", txtSituacaoFinal.getText().toString());
