...
public class TerceiroBimestreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.terceiro_bimestre_activity_main);
    ...
    private void salvarSharedPreferences(){
        ...
        mediaEscolar.putString("editMateriaTerceiroBimestre", editMateria.getText().toString());
        ...
        mediaEscolar.putString("txtResultadoTerceiroBimestre", txtResultado.getText().toString());
        mediaEscolar.putString("txtSituacaoFinalTerceiroBimestre", txtSituacaoFinal.getText().toString());
